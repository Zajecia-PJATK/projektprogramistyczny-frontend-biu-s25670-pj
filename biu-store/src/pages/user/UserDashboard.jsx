    ...
    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                <div className="top ">
                    <div className=" bg-gray-50 py-5 border border-gray-100">
                        <div className="">
                            {/* Name  */}
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden border border-gray-100 md:flex-row">
                                                            ...
                                                            >
                                                                <div className="flex flex-1 items-stretch">
                                                                    <div className="flex-shrink-0">
                                                                        <img
                                                                            className="h-40 border border-gray-200 object-contain"
                                                                            src={productImageUrl}
                                                                            alt="img"
                                                                        />
                                                                    </div>
